...
AppPublisher=Redex Team
AppPublisherURL=https://redex-project.org/
AppSupportURL=https://redex-project.org/
AppUpdatesURL=https://redex-project.org/
...
begin
  Result := True;
    ...
    if not WizardSilent() and IsAdmin() then begin
      if MsgBox('This User Installer is not meant to be run as an Administrator. If you would like to install VS Code for all users in this system, download the System Installer instead from https://redex-project.org. Are you sure you want to continue?', mbError, MB_OKCANCEL) = IDCANCEL then begin
        Result := False;
      end;
    end;
  #endif
