...
const makeTranslator = (workspace: SimulationWorkspace, indexRoot: string) => {
	...
	if (lastIndex === -1) {
		throw new Error(`Index path ${indexPath} does not contain 'vscode-redex', please ensure the index is generated in the correct workspace`);
	}
