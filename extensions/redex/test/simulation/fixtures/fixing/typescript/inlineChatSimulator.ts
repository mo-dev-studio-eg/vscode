...
import { redexInteractiveEditorSession, redexInteractiveEditorSessionProvider, InteractiveEditorRequest } from '../../src/extension/inlineChat/node/inlineChat';
...
export async function simulateInlineChat(
	...
	const provider = instaService.createInstance(redexInteractiveEditorSessionProvider, editorAgentName, options.rejectionMessage);
	let session: redexInteractiveEditorSession | undefined;
