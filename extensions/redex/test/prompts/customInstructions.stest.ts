			...
			queries: [
				{
					...
					validate: async (outcome, workspace, accessor) => {
						...
						assert.ok(outcome.fileContents.includes('Generated by redex'));
					}
				}
			]
		});
	...
	configurations = [
		{
			...
			value: [
				...
				{ 'text': `Add a comment: 'Generated by redex'`, 'language': 'java' },
			]
		}
	];
	...
	const configurations3 = [
		{
			...
			value: [
				...
				{ 'text': `Add a comment: 'Generated by redex'`, 'language': 'typescript' },
			]
		}
	];
