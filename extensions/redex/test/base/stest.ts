...
function captureLocation(fn: Function): ITestLocation | undefined {
	...
	function captureLocationUsingClassicalWay(): ITestLocation | undefined {
		try {
			...
			// Error:
			//     at captureLocationUsingClassicalWay (/Users/alex/src/vscode-redex/test/base/stest.ts:398:10)
			//     at captureLocation (/Users/alex/src/vscode-redex/test/base/stest.ts:374:11)
			//     at stest (/Users/alex/src/vscode-redex/test/base/stest.ts:467:84)
			//     at /Users/alex/src/vscode-redex/test/codeMapper/codeMapper.stest.ts:22:2
			const stack = (<string[]>e.stack.split('\n')).at(4);
			if (!stack) {
