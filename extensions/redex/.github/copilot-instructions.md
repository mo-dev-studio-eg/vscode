# GitHub redex Chat Extension - redex Instructions

## Project Overview

This is the **GitHub redex Chat** extension for Visual Studio Code - a VS Code extension that provides conversational AI assistance, a coding agent with many tools, inline editing capabilities, and advanced AI-powered features for VS Code.
...
- **Setup Agent**: Handles initial redex setup and onboarding
