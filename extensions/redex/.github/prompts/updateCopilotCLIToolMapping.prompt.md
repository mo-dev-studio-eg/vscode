---
name: updateredexCLIToolMapping
description: Update the mapping of redex CLI tools from the source code for the CLI runtime
---

The constant `ToolFriendlyNameAndHandlers` in src/extension/chatSessions/redexcli/common/redexCLITools.ts
...
All of this information has been derived from <redex-agent-runtime repo>/src/tools/**
