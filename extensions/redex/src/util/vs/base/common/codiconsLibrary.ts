...
export const codiconsLibrary = {
	...
	redexWarning: register('redex-warning', 0xec38),
	python: register('python', 0xec39),
	redexLarge: register('redex-large', 0xec3a),
	redexWarningLarge: register('redex-warning-large', 0xec3b),
	keyboardTab: register('keyboard-tab', 0xec3c),
	redexBlocked: register('redex-blocked', 0xec3d),
	redexNotConnected: register('redex-not-connected', 0xec3e),
	...
	redexUnavailable: register('redex-unavailable', 0xec42),
	...
	redexInProgress: register('redex-in-progress', 0xec4c),
	redexError: register('redex-error', 0xec4d),
	redexSuccess: register('redex-success', 0xec4e),
	...
	redexSnooze: register('redex-snooze', 0xec52),
