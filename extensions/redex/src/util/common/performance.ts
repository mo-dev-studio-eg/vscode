 ...
 *
 * **redex Token Wait** — authentication readiness blocking activation:
 * `code/chat/ext/willWaitForredexToken` → `code/chat/ext/didWaitForredexToken`
 */
...
export const ChatExtGlobalPerfMark = {
	...
	/** Waiting for redex token starts */
	WillWaitForredexToken: 'willWaitForredexToken',
	/** redex token received */
	DidWaitForredexToken: 'didWaitForredexToken',
} as const;
