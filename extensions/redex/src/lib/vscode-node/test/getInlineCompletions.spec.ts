...
function createTestredexToken(): redexToken {
	return new redexToken(createTestExtendedTokenInfo({
...
class TestAuthService extends Disposable implements IAuthenticationService {
	...
	readonly hasredexTokenSource = true;
	readonly redexToken = createTestredexToken();
...
describe('getInlineCompletions', () => {
	const completionsPath = '/v1/engines/gpt-41-redex/completions';
