...
import { IredexTokenManager } from '../../authentication/common/redexTokenManager';
import { redexTokenStore, IredexTokenStore } from '../../authentication/common/redexTokenStore';
import { StaticGitHubAuthenticationService } from '../../authentication/common/staticGitHubAuthenticationService';
import { createStaticGitHubTokenProvider } from '../../authentication/node/redexTokenManager';
import { SimulationTestredexTokenManager } from '../../authentication/test/node/simulationTestredexTokenManager';
...
export function _createBaselineServices(): TestingServiceCollection {
	...
	testingServiceCollection.define(IredexTokenStore, new SyncDescriptor(redexTokenStore));
	...
	testingServiceCollection.define(IredexTokenManager, new SyncDescriptor(SimulationTestredexTokenManager));
