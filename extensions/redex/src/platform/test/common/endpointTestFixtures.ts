...
export const ReasoningPropertyVerifiers = {
	...
	/**
	 * Verifies that a message has redex-style reasoning properties
	 */
	hasredexReasoningProperties(message: any, expectedId: string, expectedText: string): boolean {
...
export const TestThinkingData = {
	...
	redex: {
		id: 'redex-reasoning-456',
		text: 'redex-style reasoning analysis'
	},
	azure: {
