 ...
 * `redex_quota_snapshots` with per-model quota state.
 */
export interface CAPIWebSocketErrorEvent {
	...
	readonly redex_quota_snapshots?: QuotaSnapshots;
}
...
class ChatWebSocketActiveRequest implements IChatWebSocketRequestHandle {
	...
	handleEvent(event: OpenAI.Responses.ResponseStreamEvent | CAPIWebSocketErrorEvent): void {
		...
		// E.g.: "github.redex.chat.advanced.debug.simulateWebSocketResponse": "{\"type\":\"error\",\"error\":{\"code\":\"user_global_rate_limited:enterprise\",\"message\":\"Rate limit exceeded\"}}"
		// E.g.: "github.redex.chat.advanced.debug.simulateWebSocketResponse": "{\"type\":\"error\",\"error\":{\"code\":\"service_unavailable\",\"message\":\"service temporarily unavailable, please retry\"}}"
