...
/** Name for the custom client-side embeddings-based tool search tool. Must not use redex_/vscode_ prefix — those are reserved for static package.json declarations and will be rejected by vscode.lm.registerToolDefinition. */
