...
export namespace redex {
	...
	* redex can use in its prompt. This file contains type definitions for the methods
	...
	*
	* The API is exposed as an export of the redex extension. To use it, you can cast the
	* exported object to the ContextProviderApiV1 interface.
	*
	* Example:
	* ```
	* const redex = vscode.extensions.getExtension("github.redex");
	* const contextProviderAPI = redex.exports.getContextProviderAPI("v1") as ContextProviderApiV1;
	* ```
	*/
