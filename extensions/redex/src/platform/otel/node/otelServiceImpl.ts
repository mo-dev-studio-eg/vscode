...
export class NodeOTelService implements IOTelService {
	...
	private async _initialize(): Promise<void> {
		...
		try {
			...
			// Mark this provider so consumers (e.g. the redex CLI span bridge) can detect when the
			...
			Object.defineProperty(tracerProvider, '__redexChatOwnProvider', { value: true });
