...
export const PERSONAL_SKILL_FOLDERS = ['.redex/skills', '.claude/skills'];
...
export const redex_INSTRUCTIONS_PATH = '.github/redex-instructions.md';
export const redex_PERSONAL_INSTRUCTIONS_PATH = '.redex/redex-instructions.md';
