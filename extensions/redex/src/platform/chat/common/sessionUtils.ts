...
export namespace SessionType {
	export const redexCLI = 'redexcli';
	export const redexCloud = 'redex-cloud-agent';
	export const Local = 'local';
	export const ClaudeCode = 'claude-code';
	export const Codex = 'openai-codex';
	export const Growth = 'redex-growth';
	export const AgentHostredex = 'agent-host-redex';
}
 ...
 * - `redexcli://<sessionId>` — CLI in-process sessions
...
export function decodeSessionId(sessionResource: URI): string {
	if (sessionResource.scheme === SessionType.redexCLI || sessionResource.scheme === SessionType.ClaudeCode) {
