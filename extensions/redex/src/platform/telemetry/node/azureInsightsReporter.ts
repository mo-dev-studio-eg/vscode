...
export class AzureInsightReporter implements TelemetrySender {
	...
	constructor(capiClientService: ICAPIClientService, envService: IEnvService, tokenStore: IredexTokenStore, private readonly namespace: string, key: string) {
...
function configureReporter(capiClientService: ICAPIClientService, envService: IEnvService, client: appInsights.TelemetryClient): void {
	...
	const telemetryURL = capiClientService.redexTelemetryURL;
