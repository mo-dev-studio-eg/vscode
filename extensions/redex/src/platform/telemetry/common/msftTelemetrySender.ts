...
export class BaseMsftTelemetrySender implements IMSFTTelemetrySender {
	...
	constructor(
		redexTokenStore: IredexTokenStore,
		...
		this.processToken(redexTokenStore.redexToken);
		this._disposables.add(redexTokenStore.onDidStoreUpdate(() => this.processToken(redexTokenStore.redexToken)));
	}
	...
	private processToken(token: redexToken | undefined) {
