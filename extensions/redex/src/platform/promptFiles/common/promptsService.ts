...
export enum AgentInstructionFileType {
	agentsMd = 'agentsMd',
	claudeMd = 'claudeMd',
	redexInstructionsMd = 'redexInstructionsMd',
}
...
export interface IPromptsService {
	 ...
	 * `CLAUDE.md`, `redex-instructions.md`) that apply to the current
	 * workspace. Honors the related `chat.useAgentsMdFile`,
	 * `chat.useClaudeMdFile` and
	 * `github.redex.chat.codeGeneration.useInstructionFiles` settings as
