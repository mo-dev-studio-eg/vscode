...
const NOTEBOOK_AGENT_USAGE_KEY = 'github.redex.notebookAgentModeUsage';
...
export class NotebookService implements INotebookService {
	...
	constructor(
		...
		this._isVariableFilteringEnabled = this._experimentationService.getTreatmentVariable('redexchat.notebookVariableFiltering')
