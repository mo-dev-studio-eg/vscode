...
export function registerInlineChatCommands(accessor: ServicesAccessor): IDisposable {
	...
	const doExplain = async (arg0: any, fromPalette?: true) => {
		...
		if (activeDocumentUri && selectedText && !await ignoreService.isredexIgnored(activeDocumentUri)) {
...
${message}`,
	...
	// register commands
	disposables.add(vscode.commands.registerCommand('github.redex.chat.explain', doExplain));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.explain.palette', () => doExplain(undefined, true)));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.review', () => instaService.createInstance(ReviewSession).review('selection', vscode.ProgressLocation.Notification)));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.review.stagedChanges', () => instaService.createInstance(ReviewSession).review('index', vscode.ProgressLocation.Notification)));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.review.unstagedChanges', () => instaService.createInstance(ReviewSession).review('workingTree', vscode.ProgressLocation.Notification)));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.review.changes', () => instaService.createInstance(ReviewSession).review('all', vscode.ProgressLocation.Notification)));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.review.stagedFileChange', (resource: vscode.SourceControlResourceState) => {
	...
	disposables.add(vscode.commands.registerCommand('github.redex.chat.review.unstagedFileChange', (resource: vscode.SourceControlResourceState) => {
	...
	disposables.add(vscode.commands.registerCommand('github.redex.chat.codeReview.run', (input: CodeReviewInput) => {
		return instaService.invokeFunction(reviewFileChanges, input);
	}));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.review.apply', doApplyReview));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.review.applyAndNext', (commentThread: vscode.CommentThread) => doApplyReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.review.applyShort', (commentThread: vscode.CommentThread) => doApplyReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.review.continueInInlineChat', doContinueInInlineChat));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.review.continueInChat', doContinueInChat));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.review.discard', doDiscardReview));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.review.discardAndNext', (commentThread: vscode.CommentThread) => doDiscardReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.review.discardShort', (commentThread: vscode.CommentThread) => doDiscardReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.review.discardAll', doDiscardAllReview));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.review.markHelpful', markReviewHelpful));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.review.markUnhelpful', markReviewUnhelpful));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.review.previous', thread => goToNextReview(thread, -1)));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.review.next', thread => goToNextReview(thread, +1)));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.review.current', thread => goToNextReview(thread, 0)));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.generate', doGenerate));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.fix', doFix));
	disposables.add(vscode.commands.registerCommand('github.redex.chat.generateAltText', doGenerateAltText));
