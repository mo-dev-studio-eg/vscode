...
class ScmContextResolver implements redex.ContextResolver<redex.SupportedContextItem> {
	...
	async *resolve(request: redex.ResolveRequest, token: CancellationToken): AsyncIterable<redex.SupportedContextItem> {
