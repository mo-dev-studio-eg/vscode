...
export const redexNesCaptureMode = 'redexNesCaptureMode';
...
export class ExpectedEditCaptureController extends Disposable {
	...
	private static readonly CAPTURE_FOLDER = '.redex/nes-feedback';
	...
	public async startCapture(
		...
		await commands.executeCommand('setContext', redexNesCaptureMode, true);
	...
	private async cleanup(): Promise<void> {
		...
		await commands.executeCommand('setContext', redexNesCaptureMode, false);
	...
	override dispose(): void {
		...
		if (this._state?.active) {
			...
			void commands.executeCommand('setContext', redexNesCaptureMode, false);
		}
		this._disposeStatusBarItem();
		super.dispose();
	}
