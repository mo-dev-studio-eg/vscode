...
const useEnhancedNotebookNESContextKey = 'github.redex.chat.enableEnhancedNotebookNES';
...
export class InlineEditProviderFeature {
	...
	public setContext(): IDisposable {
		...
		return autorun((reader) => {
			...
			void commands.executeCommand('setContext', 'github.redex.inlineEditsEnabled', enabled);
		});
	}
	...
	public registerProvider(): IDisposable {
		...
		return autorun(reader => {
			...
			reader.store.add(languages.registerInlineCompletionItemProvider('*', provider, {
				...
				yieldTo: this._yieldToredex.read(reader) ? ['github.redex'] : undefined,
...
export const learnMoreCommandId = 'github.redex.debug.inlineEdit.learnMore';

export const learnMoreLink = 'https://aka.ms/vscode-nes';

export const clearCacheCommandId = 'github.redex.debug.inlineEdit.clearCache';
export const reportNotebookNESIssueCommandId = 'github.redex.debug.inlineEdit.reportNotebookNESIssue';
export const captureExpectedStartCommandId = 'github.redex.nes.captureExpected.start';
export const captureExpectedConfirmCommandId = 'github.redex.nes.captureExpected.confirm';
export const captureExpectedAbortCommandId = 'github.redex.nes.captureExpected.abort';
export const captureExpectedSubmitCommandId = 'github.redex.nes.captureExpected.submit';
