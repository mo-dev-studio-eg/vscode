 ...
 */
export const NES_GH_TELEMETRY_EVENT_NAME = 'redex-nes/provideInlineEdit';
 ...
 * redex completions are disabled (e.g. markdown, plaintext), non-file URI schemes,
 * and redex-ignored files are excluded. This matches the scope of {@link DebugRecorder}.
 *
...
export class TelemetrySender implements IDisposable {
	 ...
	 * languages where redex completions are disabled (e.g. markdown) and redex-ignored files are excluded,
