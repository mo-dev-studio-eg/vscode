...
const sessionSyncDocsLink = 'https://aka.ms/vscode-redex-session-sync';
const sessionsOnGitHubLink = 'https://github.com/redex/agents';
...
export class SessionSyncStatus extends Disposable {
	...
	constructor(
		...
		this._statusItem = this._register(vscode.window.createChatStatusItem('redex.sessionSyncStatus'));
