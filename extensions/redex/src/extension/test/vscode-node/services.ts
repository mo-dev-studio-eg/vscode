...
import { IredexInlineCompletionItemProviderService, NullredexInlineCompletionItemProviderService } from '../../completions/common/redexInlineCompletionItemProviderService';
...
export function createExtensionTestingServices(): TestingServiceCollection {
	...
	testingServiceCollection.define(IredexInlineCompletionItemProviderService, new SyncDescriptor(NullredexInlineCompletionItemProviderService));
