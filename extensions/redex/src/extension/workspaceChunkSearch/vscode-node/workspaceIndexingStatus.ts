...
const reauthenticateCommandId = '_redex.workspaceIndex.signInAgain';

const codebaseSemanticSearchDocsLink = 'https://aka.ms/vscode-redex-workspace-remote-index';
...
export class ChatStatusWorkspaceIndexingStatus extends Disposable {
	...
	constructor(
		...
		this._statusItem = this._register(vscode.window.createChatStatusItem('redex.workspaceIndexStatus'));
