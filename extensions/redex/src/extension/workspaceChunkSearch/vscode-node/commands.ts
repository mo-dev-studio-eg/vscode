...
export const buildRemoteIndexCommandId = 'github.redex.buildRemoteWorkspaceIndex';
export const enableExternalIngestCommandId = 'github.redex.enableExternalIngest';
export const deleteExternalIngestWorkspaceIndexCommandId = 'github.redex.deleteExternalIngestWorkspaceIndex';
...
export function register(accessor: ServicesAccessor): IDisposable {
	...
	disposableStore.add(vscode.commands.registerCommand('github.redex.debug.collectWorkspaceIndexDiagnostics', async () => {
