...
export class ToolsContribution extends Disposable {
	constructor(
		...
		for (const [name, tool] of toolsService.redexTools) {
		...
		this._register(vscode.commands.registerCommand('github.redex.debug.resetVirtualToolGroups', async () => {
		...
		this._register(vscode.commands.registerCommand('github.redex.chat.tools.memory.showMemories', async () => {
		...
		this._register(vscode.commands.registerCommand('github.redex.chat.tools.memory.resolveMemoryFileUri', (memoryPath: string, sessionResource?: string): string | undefined => {
		...
		this._register(vscode.commands.registerCommand('github.redex.chat.tools.memory.clearMemories', async () => {
