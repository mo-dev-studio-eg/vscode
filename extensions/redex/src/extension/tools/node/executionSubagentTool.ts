...
import { redexToolMode, IredexTool, ToolRegistry } from '../common/toolsRegistry';
...
class ExecutionSubagentTool implements IredexTool<IExecutionSubagentParams> {
	...
	async resolveInput(input: IExecutionSubagentParams, promptContext: IBuildPromptContext, _mode: redexToolMode): Promise<IExecutionSubagentParams> {
