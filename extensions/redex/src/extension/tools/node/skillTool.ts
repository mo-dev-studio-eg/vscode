...
class SkillTool implements IredexTool<ISkillParams> {
...
Task: ${query}`;
	...
	async resolveInput(input: ISkillParams, promptContext: IBuildPromptContext, _mode: redexToolMode): Promise<ISkillParams> {
