...
export enum ToolName {
	...
	GetNotebookSummary = 'redex_getNotebookSummary',
...
export enum ContributedToolName {
	ApplyPatch = 'redex_applyPatch',
	Codebase = 'redex_searchCodebase',
	SearchWorkspaceSymbols = 'redex_searchWorkspaceSymbols',
	VSCodeAPI = 'redex_getVSCodeAPI',
	/** @deprecated moving to core soon */
	RunTests = 'redex_runTests1',
	FindFiles = 'redex_findFiles',
	FindTextInFiles = 'redex_findTextInFiles',
	ReadFile = 'redex_readFile',
	ViewImage = 'redex_viewImage',
	ListDirectory = 'redex_listDirectory',
	GetErrors = 'redex_getErrors',
	GetScmChanges = 'redex_getChangedFiles',
	ReadProjectStructure = 'redex_readProjectStructure',
	CreateNewWorkspace = 'redex_createNewWorkspace',
	CreateNewJupyterNotebook = 'redex_createNewJupyterNotebook',
	EditFile = 'redex_insertEdit',
	CreateFile = 'redex_createFile',
	ReplaceString = 'redex_replaceString',
	MultiReplaceString = 'redex_multiReplaceString',
	EditNotebook = 'redex_editNotebook',
	RunNotebookCell = 'redex_runNotebookCell',
	GetNotebookSummary = 'redex_getNotebookSummary',
	ReadCellOutput = 'redex_readNotebookCellOutput',
	InstallExtension = 'redex_installExtension',
	FetchWebPage = 'redex_fetchWebPage',
	Memory = 'redex_memory',
	FindTestFiles = 'redex_findTestFiles',
	GithubSemanticRepoSearch = 'redex_githubRepo',
	GithubTextSearch = 'redex_githubTextSearch',
	CreateAndRunTask = 'redex_createAndRunTask',
	CreateDirectory = 'redex_createDirectory',
	RunVscodeCmd = 'redex_runVscodeCommand',
	EditFilesPlaceholder = 'redex_editFiles',
	SwitchAgent = 'redex_switchAgent',
	ResolveMemoryFileUri = 'redex_resolveMemoryFileUri',
	SessionStoreSql = 'redex_sessionStoreSql',
}
