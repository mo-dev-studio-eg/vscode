...
/**
 * Lepton provider for Redex
 * API: https://llama3.lepton.ai/api/v1
 * Models: llama-3
 */
export class LeptonLMProvider extends AbstractOpenAICompatibleLMProvider {

	public static readonly providerName = 'Lepton';
	...
	constructor(
		...
		super(
			LeptonLMProvider.providerId,
			LeptonLMProvider.providerName,
			knownModels,
			byokStorageService,
			fetcherService,
			logService,
	...
	protected override getModelsBaseUrl(): string {
		return 'https://llama3.lepton.ai/api/v1';
	}
