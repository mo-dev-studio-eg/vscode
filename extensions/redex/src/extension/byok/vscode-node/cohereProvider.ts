...
/**
 * Cohere provider for Redex
 * API: https://api.cohere.ai/v1
 * Models: command-r-plus, command-r
 */
export class CohereLMProvider extends AbstractOpenAICompatibleLMProvider {

	public static readonly providerName = 'Cohere';
	...
	constructor(
		...
		super(
			CohereLMProvider.providerId,
			CohereLMProvider.providerName,
			knownModels,
			byokStorageService,
			fetcherService,
			logService,
