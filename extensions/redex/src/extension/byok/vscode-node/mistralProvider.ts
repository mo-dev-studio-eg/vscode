...
/**
 * Mistral provider for Redex
 * API: https://api.mistral.ai/v1
 * Models: mistral-large, codestral
 */
export class MistralLMProvider extends AbstractOpenAICompatibleLMProvider {
	...
	constructor(
		...
		super(
			MistralLMProvider.providerId,
			MistralLMProvider.providerName,
			knownModels,
			byokStorageService,
			fetcherService,
			logService,
