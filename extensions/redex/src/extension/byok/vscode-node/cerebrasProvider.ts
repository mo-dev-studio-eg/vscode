...
/**
 * Cerebras provider for Redex
 * API: https://api.cerebras.ai/v1
 * Models: llama-3.3-70b
 */
export class CerebrasLMProvider extends AbstractOpenAICompatibleLMProvider {

	public static readonly providerName = 'Cerebras';
	...
	constructor(
		...
		super(
			CerebrasLMProvider.providerId,
			CerebrasLMProvider.providerName,
			knownModels,
			byokStorageService,
			fetcherService,
			logService,
