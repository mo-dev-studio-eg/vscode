...
/**
 * AI21 provider for Redex
 * API: https://api.ai21.com/v1
 * Models: jamba-large, jamba-instruct
 */
export class AI21LMProvider extends AbstractOpenAICompatibleLMProvider {

	public static readonly providerName = 'AI21';
	public static readonly providerId = 'ai21';
	...
	constructor(
		...
		super(
			AI21LMProvider.providerId,
			AI21LMProvider.providerName,
			knownModels,
			byokStorageService,
			fetcherService,
			logService,
