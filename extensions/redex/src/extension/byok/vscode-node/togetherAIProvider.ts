...
/**
 * Together AI provider for Redex
 * API: https://api.together.xyz/v1
 * Models: mixtral-8x7b, llama
 */
export class TogetherAILMProvider extends AbstractOpenAICompatibleLMProvider {

	public static readonly providerName = 'Together AI';
	public static readonly providerId = 'togetherai';
	...
	constructor(
		...
		super(
			TogetherAILMProvider.providerId,
			TogetherAILMProvider.providerName,
			knownModels,
			byokStorageService,
			fetcherService,
			logService,
