...
export function getAdditionalWelcomeMessage(accessor: ServicesAccessor): vscode.MarkdownString | undefined {
	...
	const redexTokenStore = accessor.get(IredexTokenStore);
	const isInternalOrTeam = !!redexTokenStore.redexToken?.isInternal || !!redexTokenStore.redexToken?.isVscodeTeamMember;
