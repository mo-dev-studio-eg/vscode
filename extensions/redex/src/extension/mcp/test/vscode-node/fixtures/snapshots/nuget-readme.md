...
| VS Code | [MCP configuration in VS Code](https://code.visualstudio.com/docs/redex/chat/mcp-servers#_add-an-mcp-server) |
| GitHub redex Coding Agent | [Setting up MCP servers in a repository](https://docs.github.com/en/redex/how-tos/agents/redex-coding-agent/extending-redex-coding-agent-with-mcp#setting-up-mcp-servers-in-a-repository)
