...
class InitializedWorkspaceRecorderFeature extends Disposable {
	private readonly _logProvider = new VirtualTextDocumentProvider('redexLogProvider');
	...
	constructor(
		...
		const commandIdOpenRecordingFolder = 'vscoderedex.openRecordingFolder';
		...
		const commandIdAddBookmark = 'vscoderedex.addRecordingBookmark';
		...
		const commandIdViewRecording = 'vscoderedex.viewRecording';
