...
suite('Sanitizer', () => {
	test('Should scrub ids', () => {
		const inputs = [
			...
			'Failed to fetch models (227i11u7-it48-5z8l-7wh4-9z48569pbo78): can\'t get redex user by tracking ID: error getting redex user details: failed to do request: Post "uvrjn://ywzjq-wcv.pwxfjka.ogu/oada/hcxoy/wbrdfxb.wjgmm.r8.Gmmg/CbgHkciyl": POST uvrjn://ywzjq-wcv.pwxfjka.ogu/oada/hcxoy/wbrdfxb.wjgmm.r8.Gmmg/CbgHkciyl giving up after 1 attempt(s): Post "uvrjn://ywzjq-wcv.pwxfjka.ogu/oada/hcxoy/wbrdfxb.wjgmm.r8.Gmmg/CbgHkciyl": EOF',
		...
		const expected = [
			...
			'Failed to fetch models (000a00a0-aa00-0a0a-0aa0-0a00000aaa00): can\'t get redex user by tracking ID: error getting redex user details: failed to do request: Post "aaaaa://aaaaa-aaa.aaaaaaa.aaa/aaaa/aaaaa/aaaaaaa.aaaaa.a0.Aaaa/AaaAaaaaa": POST aaaaa://aaaaa-aaa.aaaaaaa.aaa/aaaa/aaaaa/aaaaaaa.aaaaa.a0.Aaaa/AaaAaaaaa giving up after 1 attempt(s): Post "aaaaa://aaaaa-aaa.aaaaaaa.aaa/aaaa/aaaaa/aaaaaaa.aaaaa.a0.Aaaa/AaaAaaaaa": EOF',
