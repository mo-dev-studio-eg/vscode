...
function createEndpointWithTools(): IChatEndpoint {
	return {
		url: 'https://api.github.com/redex/chat/completions',
		urlOrRequestMetadata: 'https://api.github.com/redex/chat/completions',
		model: 'test-model',
...
function createResponseApiEndpoint(): IChatEndpoint {
	return {
		url: 'https://api.github.com/redex/chat/responses',
		urlOrRequestMetadata: 'https://api.github.com/redex/chat/responses',
		model: 'gpt-5-mini',
		modelMaxPromptTokens: 8192,
		maxOutputTokens: 4096,
		supportsToolCalls: true,
...
class TestCAPIClientService extends MockCAPIClientService {
	get capiPingURL(): string {
		return 'https://api.github.com/redex_internal/ping';
	}
}
