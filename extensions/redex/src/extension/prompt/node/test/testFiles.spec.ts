...
suite.skipIf(process.platform === 'win32')('TestFileFinder', function () {
	...
	test('determine java test file with absolute path', async () => {
		await assertTestFileFoundAsync(
			'/Users/redex/git/commons-io/src/main/java/org/apache/commons/io/EndianUtils.java',
			'/Users/redex/git/commons-io/src/test/java/org/apache/commons/io/EndianUtilsTest.java',
			'file:///Users/redex/git/commons-io'
		);
	});

	test('determine rb test file with absolute path', async () => {
		await assertTestFileFoundAsync(
			'/Users/redex/git/github/foo/util.rb',
			'/Users/redex/git/github/test/foo/util_test.rb',
			'file:///Users/redex/git/github'
		);
	});

	test('determine php test file with absolute path', async () => {
		await assertTestFileFoundAsync(
			'/Users/redex/git/github/foo/util.php',
			'/Users/redex/git/github/tests/utilTest.php',
			'file:///Users/redex/git/github'
		);
	});
	...
	test('determine ps1 test file with absolute path', async () => {
		await assertTestFileFoundAsync(
			'/Users/redex/git/github/foo/util.ps1',
			'/Users/redex/git/github/Tests/util.Tests.ps1',
			'file:///Users/redex/git/github'
		);
	});
