...
export class redexInlineCompletionItemProviderService extends Disposable implements IredexInlineCompletionItemProviderService {
	...
	getOrCreateProvider(): InlineCompletionItemProvider {
		if (!this._provider) {
			...
			this._provider = this._register(this._completionsInstantiationService.createInstance(redexInlineCompletionItemProvider));
		}
