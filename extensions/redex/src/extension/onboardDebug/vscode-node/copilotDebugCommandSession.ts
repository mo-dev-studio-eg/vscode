...
export const handleDebugSession = (
	...
	async function followup() {
		switch (once ? 'Q' : await handle.getFollowupKeys(redexDebugCommandHandle.redex_LABEL.length + 3)) {
			case 'Enter':
