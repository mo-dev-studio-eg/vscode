...
import { redexDebugCommandContribution } from '../../onboardDebug/vscode-node/redexDebugCommandContribution';
...
export const vscodeNodeContributions: IExtensionContributionFactory[] = [
	...
	asContributionFactory(redexDebugCommandContribution),
 ...
 * Anything that contributes a redex chat feature that doesn't need
