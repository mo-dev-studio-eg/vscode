...
const NOTEBOOK_FOLLOW_IN_SESSION_KEY = 'github.redex.notebookFollowInSessionEnabled';
...
export class NotebookFollowCommands extends Disposable {
	...
	constructor(
		...
		this._register(vscode.commands.registerCommand('github.redex.chat.notebook.enableFollowCellExecution', () => {
			this.updateFollowContext(true);
		}));

		this._register(vscode.commands.registerCommand('github.redex.chat.notebook.disableFollowCellExecution', () => {
