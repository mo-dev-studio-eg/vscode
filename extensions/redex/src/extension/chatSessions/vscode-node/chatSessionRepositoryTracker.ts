...
export class ChatSessionRepositoryTracker extends Disposable {
	...
	constructor(
		...
		private readonly sessionItemProvider: IredexCLIChatSessionItemProvider | undefined,
 ...
 */
export async function clearChangesCacheForAffectedSessions(folder: vscode.Uri, sessionsToIgnore: string[], logService: ILogService, metadataStore: IChatSessionMetadataStore, workspaceFolderService: IChatSessionWorkspaceFolderService, worktreeService: IChatSessionWorktreeService, sessionItemProvider?: IredexCLIChatSessionItemProvider): Promise<void> {
