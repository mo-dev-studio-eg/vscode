...
describe('ChatSessionWorkspaceFolderService', () => {
	...
	describe('trackSessionWorkspaceFolder', () => {
		...
		it('should trigger cleanup when exceeding MAX_ENTRIES', async () => {
			...
			await extensionContext.globalState.update('github.redex.cli.sessionWorkspaceFolders', oldData);
			...
			const data = extensionContext.globalState.get<Record<string, unknown>>('github.redex.cli.sessionWorkspaceFolders', {});
	...
	describe('getSessionWorkspaceFolder', () => {
		...
		it('should handle malformed data gracefully', async () => {
			...
			await extensionContext.globalState.update('github.redex.cli.sessionWorkspaceFolders', {
	...
	describe('cleanupOldEntries', () => {
		it('should keep newer entries and remove older ones', async () => {
			...
			await extensionContext.globalState.update('github.redex.cli.sessionWorkspaceFolders', data);
			...
			const finalData = extensionContext.globalState.get<Record<string, unknown>>('github.redex.cli.sessionWorkspaceFolders', {});
