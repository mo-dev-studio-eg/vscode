...
/**
 * Fake implementation of IredexCLISessionService for testing.
 */
...
describe('redexCLIFolderRepositoryManager', () => {
	const disposables = new DisposableStore();
	let manager: redexCLIFolderRepositoryManager;
	let worktreeService: FakeChatSessionWorktreeService;
	let workspaceFolderService: FakeChatSessionWorkspaceFolderService;
	let sessionService: FakeredexCLISessionService;
	...
	beforeEach(() => {
		...
		sessionService = new FakeredexCLISessionService();
		...
		manager = new redexCLIFolderRepositoryManager(
			worktreeService,
