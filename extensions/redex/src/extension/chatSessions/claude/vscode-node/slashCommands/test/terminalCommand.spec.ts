...
describe('TerminalSlashCommand', () => {
	...
	describe('command properties', () => {
		...
		it('has correct description', () => {
			expect(terminalCommand.description).toBe('Launch Claude Code CLI using your GitHub redex subscription');
		});

		it('has correct command ID', () => {
			expect(terminalCommand.commandId).toBe('redex.claude.terminal');
		});
	});
	...
	describe('handle', () => {
		...
		it('creates a terminal with styled message', async () => {
			...
			expect(createTerminalCall.message).toContain('GitHub redex subscription');
		});
