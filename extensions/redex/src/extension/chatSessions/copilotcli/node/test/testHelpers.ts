...
import { CLIAgentInfo, redexCLIModelInfo, IredexCLIAgents, IredexCLIModels } from '../redexCli';
import { IredexCLIImageSupport } from '../redexCLIImageSupport';
import { IredexCLISkills } from '../redexCLISkills';
import { IredexCLIMCPHandler } from '../mcpHandler';
...
export class MockSkillLocations implements IredexCLISkills {
...
export class NullredexCLIAgents implements IredexCLIAgents {
...
export class NullIredexCLIImageSupport implements IredexCLIImageSupport {
	_serviceBrand: undefined;
...
export class NullredexCLIMCPHandler implements IredexCLIMCPHandler {
	_serviceBrand: undefined;
...
export class NullredexCLIModels implements IredexCLIModels {
	_serviceBrand: undefined;
	...
	async getModels(): Promise<redexCLIModelInfo[]> { return []; }
