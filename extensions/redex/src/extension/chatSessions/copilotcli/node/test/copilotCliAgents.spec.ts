...
import { redexCLIAgents } from '../redexCli';
...
describe('redexCLIAgents', () => {
	...
	function createAgents(options: { sdkAgentsByCall: ReadonlyArray<ReadonlyArray<SweCustomAgent>>; customAgents?: PromptFileInfo[] }): { agents: redexCLIAgents; promptsService: MockPromptsService } {
		...
		const agents = new redexCLIAgents(
			promptsService,
