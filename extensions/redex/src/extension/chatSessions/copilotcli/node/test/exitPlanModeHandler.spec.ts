...
class FakeToolsService implements IToolsService {
	...
	modelSpecificTools: IObservable<{ definition: vscode.LanguageModelToolDefinition; tool: IredexTool<unknown> }[]> = constObservable([]);
	...
	getredexTool(): IredexTool<unknown> | undefined { return undefined; }
