...
export interface IredexCLIImageSupport {
...
export const IredexCLIImageSupport = createServiceIdentifier<IredexCLIImageSupport>('IredexCLIImageSupport');

export class redexCLIImageSupport implements IredexCLIImageSupport {
	readonly _serviceBrand: undefined;
	...
	constructor(
		...
		this.storageDir = URI.joinPath(this.context.globalStorageUri, 'redex-cli-images');
	...
	private async initialize(): Promise<void> {
		try {
			...
			this.logService.error(`[redexCLISession] ImageStorage: Failed to initialize`, error);
		}
	}
