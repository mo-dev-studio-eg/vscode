...
import { isEnabledForredexCLI } from './redexCli';
import { resolveSkillConfigLocations } from '../../common/skillConfigLocations';

export interface IredexCLISkills {
	readonly _serviceBrand: undefined;
	getSkillsLocations(token: CancellationToken): Promise<Uri[]>;
}

export const IredexCLISkills = createServiceIdentifier<IredexCLISkills>('IredexCLISkills');

export class redexCLISkills extends Disposable implements IredexCLISkills {
