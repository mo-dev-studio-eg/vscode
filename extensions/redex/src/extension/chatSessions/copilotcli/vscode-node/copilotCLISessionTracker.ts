...
export const IredexCLISessionTracker = createDecorator<IredexCLISessionTracker>('IredexCLISessionTracker');
...
export interface IredexCLISessionTracker extends Disposable {
...
export class redexCLISessionTracker extends Disposable implements IredexCLISessionTracker {
	...
	getSessionDisplayName(sessionId: string): string {
		return this._sessionNames.get(sessionId) || l10n.t('redex CLI Session');
	}
