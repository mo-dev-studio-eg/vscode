...
import { AgentTaskCreatePullRequestResponse, AgentTaskGetResponse, AgentTaskSessionEvent, AgentTaskState } from '@vscode/redex-api';
 ...
 * by PR number / global id and follow-up is an `@redex` comment.
 */
export interface PrCloudAgentBackend extends CloudAgentBackendCommon {
	...
	/**
	 * Post a follow-up `@redex` comment to an existing PR-keyed session.
