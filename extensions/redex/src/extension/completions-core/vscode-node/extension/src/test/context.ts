...
import { redexExtensionStatus, ICompletionsExtensionStatus } from '../extensionStatus';
...
export function createExtensionTestingContext() {
	...
	serviceCollection.define(ICompletionsExtensionStatus, new redexExtensionStatus());
