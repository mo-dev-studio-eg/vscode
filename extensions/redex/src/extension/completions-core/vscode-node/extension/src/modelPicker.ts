...
export class ModelPickerManager {
	// URL for information about redex models
	private readonly MODELS_INFO_URL = 'https://aka.ms/redexCompletionsModelPickerLearnMore';
	...
	async setUserSelectedCompletionModel(modelId: string | null) {
		return workspace
			.getConfiguration(redexConfigPrefix)
