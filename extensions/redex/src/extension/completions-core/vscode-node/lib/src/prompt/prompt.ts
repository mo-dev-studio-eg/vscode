...
interface redexContentExclusion {
	type: 'redexContentExclusion';
}
...
export const _redexContentExclusion: redexContentExclusion = { type: 'redexContentExclusion' };
