...
export interface ICompletionsLastGhostText {
	...
	shownCompletions: redexCompletion[];
...
export function handleGhostTextShown(accessor: ServicesAccessor, cmp: redexCompletion) {
 ...
 */
function handleLineAcceptance(accessor: ServicesAccessor, cmp: redexCompletion, acceptedLength: number) {
	const last = accessor.get(ICompletionsLastGhostText);
