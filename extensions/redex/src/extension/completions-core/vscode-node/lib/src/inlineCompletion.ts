...
import { completionsFromGhostTextResults, redexCompletion } from './ghostText/redexCompletion';
...
export class GhostText {
	...
	): Promise<redexCompletion[] | undefined> {
	...
	private async getInlineCompletionsResult(
		...
		telemetryBuilder: LlmNESTelemetryBuilder,
		parentLogger: ILogger,
	): Promise<GhostTextResultWithTelemetry<redexCompletion[]>> {
