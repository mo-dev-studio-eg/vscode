...
suite('contextProviderRegistryTs', function () {
	...
	setup(function () {
		...
		telemetryData.filtersAndExp.exp.variables['redextscontextproviderparams'] = JSON.stringify({
	...
	test('bad JSON is ignored', function () {
		telemetryData.filtersAndExp.exp.variables['redextscontextproviderparams'] = '{"badJSON": true';
