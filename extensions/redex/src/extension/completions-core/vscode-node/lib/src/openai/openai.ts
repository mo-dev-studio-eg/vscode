...
export interface APIChoice {
	...
	redexAnnotations?: redexNamedAnnotationList; // optional annotations from the proxy
...
export interface APIJsonData {
	...
	/* redex-specific annotations returned by the proxy. */
	redex_annotations?: redexNamedAnnotationList;
...
export function convertToAPIChoice(
	...
	return {
		...
		redexAnnotations: jsonData.redex_annotations,
