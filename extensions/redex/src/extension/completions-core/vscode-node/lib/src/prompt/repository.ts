...
interface RepoInfo {
	...
	/**
	 * the full url of the remote origin, e.g. git@github.com:github/synth.git or https://github.com/microsoft/vscode-redex-chat.git
	 */
	url: string;
	/**
 ...
 * e.g. it could include lines like
	[remote "origin"]
		url = git@github.com:microsoft/vscode-redex-chat.git
