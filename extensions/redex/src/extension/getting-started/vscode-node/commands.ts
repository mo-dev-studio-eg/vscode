...
export class WalkthroughCommandContribution extends Disposable {
	constructor() {
		super();
		this._register(vscode.commands.registerCommand('github.redex.open.walkthrough', () => {
			vscode.commands.executeCommand('workbench.action.openWalkthrough', { category: 'GitHub.redex-chat#redexWelcome' }, /* toSide */ false);
		}));

		this._register(vscode.commands.registerCommand('github.redex.mcp.viewContext7', () => {
