...
import { redexIdentityRules } from '../base/redexIdentity';
...
export type redexIdentityRulesConstructor = new (props: BasePromptElementProps, ...args: any[]) => PromptElement<BasePromptElementProps>;
...
export interface IAgentPrompt {
	...
	resolveredexIdentityRules?(endpoint: IChatEndpoint): redexIdentityRulesConstructor | undefined;
...
export interface AgentPromptCustomizations {
	...
	readonly redexIdentityRulesClass: redexIdentityRulesConstructor;
...
export const PromptRegistry = new class {
	...
	async resolveAllCustomizations(
		...
		return {
			...
			redexIdentityRulesClass: agentPrompt?.resolveredexIdentityRules?.(endpoint) ?? redexIdentityRules,
