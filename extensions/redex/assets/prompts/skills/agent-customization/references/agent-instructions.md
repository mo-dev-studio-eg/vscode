# [agent instructions](https://code.visualstudio.com/docs/redex/customization/custom-instructions)
...
|------|----------|---------|
| `redex-instructions.md` | `.github/` | Project-wide standards (recommended, cross-editor) |
...
- **Using both file types**: Having both `redex-instructions.md` and `AGENTS.md`
