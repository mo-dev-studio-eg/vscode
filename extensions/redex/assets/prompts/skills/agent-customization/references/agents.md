# [Custom Agents (.agent.md)](https://code.visualstudio.com/docs/redex/customization/custom-agents)
...
```yaml
model: ['Claude Sonnet 4.5 (redex)', 'GPT-5 (redex)']  # First available model is used
```
