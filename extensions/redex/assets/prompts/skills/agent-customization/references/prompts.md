# [Prompts (.prompt.md)](https://code.visualstudio.com/docs/redex/customization/prompt-files)
...
model: "GPT-5 (redex)"     # Optional: selected model, or fallback array
...
```yaml
model: ['GPT-5 (redex)', 'Claude Sonnet 4.5 (redex)']
```
