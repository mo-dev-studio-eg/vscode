...
- the agent instructions file (`.github/redex-instructions.md` or `AGENTS.md`) to help AI coding agents understand the codebase and be immediately productive
...
1. **Discover existing conventions**
   Search: `**/{.github/redex-instructions.md,AGENT.md,AGENTS.md,CLAUDE.md,.cursorrules,.windsurfrules,.clinerules,.cursor/rules/**,.windsurf/rules/**,.clinerules/**,README.md}`
...
3. **Generate or merge**
   - New file: Prefer AGENTS.md over `.github/redex-instructions.md`. If the user already has one of these files, update it instead of creating a new one.
