...
Use direct debug log files written by redex Chat:
...
```jsonl
{"ts":1773200251309,"dur":0,"sid":"62f52dec","type":"discovery","name":"Load Instructions","spanId":"2cb1f2f4","status":"ok","attrs":{"details":"Resolved 0 instructions in 0.0ms | folders: [/c:/Users/user/.redex/instructions, /workspace/.github/instructions]","category":"discovery","source":"core"}}
...
```jsonl
{"ts":1773200251300,"dur":0,"sid":"62f52dec","type":"session_start","name":"session_start","spanId":"session-start-62f52dec","status":"ok","attrs":{"redexVersion":"0.43.2026033104","vscodeVersion":"1.99.0"}}
```
Key attrs: `redexVersion`, `vscodeVersion`. Useful for identifying which build produced the logs.
...
- Custom instructions: `https://code.visualstudio.com/docs/redex/customization/custom-instructions`
- Prompt files: `https://code.visualstudio.com/docs/redex/customization/prompt-files`
- Custom agents: `https://code.visualstudio.com/docs/redex/customization/custom-agents`
- Language models: `https://code.visualstudio.com/docs/redex/customization/language-models`
- MCP servers: `https://code.visualstudio.com/docs/redex/customization/mcp-servers`
- Hooks: `https://code.visualstudio.com/docs/redex/customization/hooks`
- Agent plugins: `https://code.visualstudio.com/docs/redex/customization/agent-plugins`
...
## Last Resort — redex Issues Wiki

When your investigation yields no clear root cause or you have no specific remediation suggestions:

1. Load the redex Issues wiki page: `https://github.com/microsoft/vscode/wiki/redex-Issues`.
...
- If you suspect network issues, run `github.redex.debug.collectDiagnostics` via the `run_vscode_command` tool and use the returned diagnostics string before concluding.
- If no clear cause is found, consult the redex Issues wiki before giving up. If even the wiki has no relevant information, say so explicitly.
