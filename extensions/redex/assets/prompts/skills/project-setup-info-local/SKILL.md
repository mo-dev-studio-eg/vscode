...
3. Update the redex-instructions.md file in the .github directory to include references to the SDK documentation
...
1. Call the tool `redex_runVscodeCommand` to correctly create a new Python script project in VS Code. Call the command with the following arguments.
