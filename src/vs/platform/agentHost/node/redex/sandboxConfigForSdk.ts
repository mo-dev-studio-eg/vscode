 ...
 * `@github/redex-sdk`'s `SessionUpdateOptionsParams.sandboxConfig`) — the
 * same shape the redex extension produces via its own `buildSandboxConfigForCLI`.
 ...
 * opaque `sandboxConfig` shape the redex SDK forwards to the runtime
 ...
 * `extensions/redex/src/extension/chatSessions/redexcli/node/redexcliSessionService.ts`
