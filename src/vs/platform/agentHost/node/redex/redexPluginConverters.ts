...
import type { CustomAgentConfig, MCPServerConfig, SessionConfig } from '@github/redex-sdk';
 ...
 * callbacks from {@link redexAgentSession} that are merged with plugin hooks.
 */
