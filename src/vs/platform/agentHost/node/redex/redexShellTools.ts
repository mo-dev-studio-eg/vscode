...
import type { Tool, ToolResultObject } from '@github/redex-sdk';
 ...
 * The full sentinel format is: `<<<redex_SENTINEL_<uuid>_EXIT_<code>>>`.
 */
const SENTINEL_PREFIX = '<<<redex_SENTINEL_';
...
/**
 * Routes a resolved shell executable to one of the redex SDK's two
...
/**
 * Builds the SDK {@link Tool} set that overrides the redex SDK's two
