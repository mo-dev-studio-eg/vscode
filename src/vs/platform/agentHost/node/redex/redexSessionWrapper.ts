...
import type { redexSession, SessionEvent, SessionEventPayload, SessionEventType } from '@github/redex-sdk';
import { Emitter, Event } from '../../../../base/common/event.js';
import { Disposable, toDisposable } from '../../../../base/common/lifecycle.js';

/**
 * Thin wrapper around {@link redexSession} that exposes each SDK event as a
 * proper VS Code `Event<T>`. All subscriptions and the underlying SDK session
 * are cleaned up on dispose.
 */
export class redexSessionWrapper extends Disposable {
	...
	constructor(readonly session: redexSession) {
		super();
