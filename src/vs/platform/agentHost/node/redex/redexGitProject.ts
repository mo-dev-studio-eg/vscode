...
export interface IredexSessionContext {
	readonly cwd?: string;
...
export async function projectFromredexContext(context: IredexSessionContext | undefined, gitService: IAgentHostGitService): Promise<IAgentSessionProjectInfo | undefined> {
